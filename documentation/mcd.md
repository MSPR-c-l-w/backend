...
```mermaid
graph TD
  User["<b>User</b><br/><u>id</u><br/>#organization_id<br/>#role_id<br/>email<br/>password_hash<br/>refresh_token_hash<br/>refresh_token_expires_at<br/>email_verification_token_hash<br/>email_verification_token_expires_at<br/>email_verified_at<br/>reset_password_token_hash<br/>reset_password_token_expires_at<br/>first_name<br/>last_name<br/>date_of_birth<br/>gender<br/>height<br/>created_at<br/>updated_at<br/>deleted_at<br/>is_active<br/>is_deleted"]
  Organization["<b>Organization</b><br/><u>id</u><br/>name<br/>type<br/>branding_config<br/>created_at<br/>updated_at<br/>deleted_at<br/>is_active<br/>is_deleted"]
  Role["<b>Role</b><br/><u>id</u><br/>name"]
  HealthProfile["<b>HealthProfile</b><br/><u>id</u><br/>#user_id<br/>weight<br/>bmi<br/>physical_activity_level<br/>daily_calories_target<br/>updated_at"]
  UserAiPreferences["<b>UserAiPreferences</b><br/><u>id</u><br/>#user_id<br/>allergies<br/>regime<br/>budget<br/>objectif_ia<br/>contraintes_materielles<br/>limitations_physiques<br/>preferences_sportives<br/>updated_at"]
  AiNutritionRecommendation["<b>AiNutritionRecommendation</b><br/><u>id</u><br/>#user_id<br/>type<br/>input_image_url<br/>aliments_detectes<br/>macros<br/>suggestions<br/>meal_plan<br/>created_at"]
  AiWorkoutRecommendation["<b>AiWorkoutRecommendation</b><br/><u>id</u><br/>#user_id<br/>microservice_ref_id<br/>statut<br/>feedback<br/>generated_at<br/>updated_at"]
  Session["<b>Session</b><br/><u>id</u><br/>#user_id<br/>duration_h<br/>calories_total<br/>avg_bpm<br/>max_bpm<br/>resting_bpm<br/>created_at"]
  Exercise["<b>Exercise</b><br/><u>id</u><br/>name<br/>primary_muscles<br/>secondary_muscles<br/>level<br/>mechanic<br/>equipment<br/>category<br/>instructions<br/>image_urls"]
  SessionExercise["<b>SessionExercise</b><br/><u>#session_id</u><br/><u>#exercise_id</u>"]
  Nutrition["<b>Nutrition</b><br/><u>id</u><br/>name<br/>category<br/>calories_kcal<br/>protein_g<br/>carbohydrates_g<br/>fat_g<br/>fiber_g<br/>sugar_g<br/>sodium_mg<br/>cholesterol_mg<br/>meal_type_name<br/>water_intake_ml"]
  Meal["<b>Meal</b><br/><u>id</u><br/>#user_id<br/>#nutrition_id<br/>created_at"]
  Plan["<b>Plan</b><br/><u>id</u><br/>name<br/>price<br/>features"]
  Subscription["<b>Subscription</b><br/><u>id</u><br/>#user_id<br/>#plan_id<br/>start_date<br/>end_date<br/>status"]
  Post["<b>Post</b><br/><u>id</u><br/>#author_id<br/>#organization_id<br/>title<br/>content<br/>media_url<br/>category<br/>mood<br/>is_published<br/>created_at<br/>updated_at"]
  PostComment["<b>PostComment</b><br/><u>id</u><br/>#post_id<br/>#user_id<br/>#parent_id<br/>content<br/>created_at<br/>updated_at"]
  PostLike["<b>PostLike</b><br/><u>id</u><br/>#post_id<br/>#user_id<br/>created_at"]
  PostCommentLike["<b>PostCommentLike</b><br/><u>id</u><br/>#comment_id<br/>#user_id<br/>created_at"]
  Follow["<b>Follow</b><br/><u>id</u><br/>#follower_id<br/>#following_id<br/>created_at"]
  NutritionStaging["<b>NutritionStaging</b><br/><u>id</u><br/>cleaned_data<br/>anomalies<br/>status<br/>created_at<br/>updated_at"]
  ExerciseStaging["<b>ExerciseStaging</b><br/><u>id</u><br/>cleaned_data<br/>anomalies<br/>status<br/>created_at<br/>updated_at"]
  HealthProfileStaging["<b>HealthProfileStaging</b><br/><u>id</u><br/>cleaned_data<br/>anomalies<br/>status<br/>created_at<br/>updated_at"]
